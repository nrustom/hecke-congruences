...
let saved=read_checkpoint(path,"producer",86,1,2187)
doAssert saved.len==1 and saved[0]==A
var rejected=false
try: discard read_checkpoint(path,"different-producer",86,1,2187)
...
rejected=false
try: discard read_checkpoint(path,"producer",86,1,2187)

#!/usr/bin/env bash
# Manage the two signed ideal-image sources I=(9,T_2)M at working precision 2187.
# Source production retains the ideal cyclic coordinates for later relation verification.
set -euo pipefail
